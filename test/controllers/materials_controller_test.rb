...
class MaterialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create material" do
    assert_difference("Material.count") do
      post materials_url, params: { material: { description: @material.description, title: @material.title } }
    end
  ...
  test "should update material" do
    patch material_url(@material), params: { material: { description: @material.description, title: @material.title } }
